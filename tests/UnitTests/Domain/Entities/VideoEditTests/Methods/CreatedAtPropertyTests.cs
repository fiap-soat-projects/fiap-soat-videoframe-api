...
public class CreatedAtPropertyTests : VideoEditDependenciesMock
{
    [Fact]
    ...
    [Fact]
    public void When_VideoEdit_Is_Created_With_Explicit_CreatedAt_Then_Uses_Provided_Value()
    {
        // Arrange
        ...
        // Assert
        videoEdit.CreatedAt.Should().Be(expectedCreatedAt);
    }
}
